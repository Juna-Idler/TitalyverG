...
func initialize_settings(config : ConfigFile):
	...
	RenderingServer.global_shader_parameter_set("sleep_color",view.font_sleep_color)
	RenderingServer.global_shader_parameter_set("sleep_outline_color",view.font_sleep_outline_color)
	RenderingServer.global_shader_parameter_set("active_color",view.font_active_color)
	RenderingServer.global_shader_parameter_set("active_outline_color",view.font_active_outline_color)
	RenderingServer.global_shader_parameter_set("standby_color",view.font_standby_color)
	RenderingServer.global_shader_parameter_set("standby_outline_color",view.font_standby_outline_color)
